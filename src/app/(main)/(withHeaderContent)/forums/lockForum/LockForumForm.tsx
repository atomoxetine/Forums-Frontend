...
import { lockForum } from "./ServerActions";
...
export default function LockForumForm(props: Props) {
  ...
  function onSubmit(formData: FormData) {
    ...
    const result = confirm(`Are you sure you want to lock ${forum?.name || "null"}?`)
