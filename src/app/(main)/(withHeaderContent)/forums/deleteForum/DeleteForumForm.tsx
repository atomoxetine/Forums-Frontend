...
import { deleteForum } from "./ServerActions";
...
export default function DeleteForumForm(props: Props) {
  ...
  function onSubmit(formData: FormData) {
    ...
    const result = confirm(`Are you sure you want to delete ${forum?.name || "null"}?`)
